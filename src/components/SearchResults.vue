  ...
  methods: {
    ...
    searchHotel() {
      if (process.env.NODE_ENV === "development") {
        this.hotelUrl = "http://localhost:9000/.netlify/functions/hotel";
      } else {
        this.hotelUrl = "/.netlify/functions/hotel";
      }
      axios
        .get(this.hotelUrl, {
          params: {
    ...
    searchRestaurant() {
      if (process.env.NODE_ENV === "development") {
        this.restaurantUrl = "http://localhost:9000/.netlify/functions/restaurant";
      } else {
        this.restaurantUrl = "/.netlify/functions/restaurant";
      }
      axios
